package com.BlogPessoalGen.BlogPessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.BlogPessoalGen.BlogPessoal.controller"))
	...
	private static Contact contact() {
		return new Contact("Guilherme Rodrigues", "https://github.com/GuilhermeRodriguesSantos", "gr0331417@gmail.com");
	}
